"""
Django settings for avas_45300 project.
...
WSGI_APPLICATION = 'avas_45300.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "avas_45300 API",
    "DESCRIPTION": "API documentation for avas_45300 App",
    "VERSION": "v1",
}
